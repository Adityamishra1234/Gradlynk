...
class TakePictureScreenFundPlanner extends StatefulWidget {
  ...
  @override
  TakePictureScreenFundPlannerState createState() =>
      TakePictureScreenFundPlannerState();
}

class TakePictureScreenFundPlannerState
    extends State<TakePictureScreenFundPlanner> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        //TODO
        // In case of return back

        // Get.find<ApplicationCompleteDetailsController>()
        //     .model
        //     .documents![int.parse(widget.index!)]
        //     .viewLink = "";
