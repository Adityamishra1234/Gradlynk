...
class MultiFileUploadRaiseNewTickets extends StatefulWidget {
  String enq_id;
  String id;
  MultiFileUploadRaiseNewTickets(
      {Key? key, required this.enq_id, required this.id})
      : super(key: key);

  @override
  State<MultiFileUploadRaiseNewTickets> createState() =>
      _MultiFileUploadRaiseNewTicketsState();
}

class _MultiFileUploadRaiseNewTicketsState
    extends State<MultiFileUploadRaiseNewTickets> {
  ...
  sendFile(file, uploadFilename, String enq_id, String id) async {
    ...
    request.files.add(await http.MultipartFile.fromPath('doc1', file.path,
        filename: "ample.jpeg"));
    request.files.add(await http.MultipartFile.fromPath('doc2', file.path,
        filename: "ample.jpeg"));
