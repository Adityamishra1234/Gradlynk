...
class ProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var controller = Get.put(ContactInformationInPopUpController(), permanent: true);
    ...
    return WillPopScope(
        ...
        child: Scaffold(
                      ...
                      children: [
                                ...
                                child: ListTile(
                                  leading: Container(
                                    ...
                                    child: const Padding(
                                      ...
                                      child: Icon(Icons.label_important, color: Colors.green,)
                                    ),),
                                  title: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: CustomAutoSizeTextMontserrat(
                        ...
                        Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: [
                                Text("Advance Application Details", textAlign : TextAlign.center,style: GoogleFonts.montserrat(
                        ...
                        SizedBox(
                          child: ListView.builder(
                            ...
                            return InkWell(
                              ...
                              onTap: (){
                                if (Get.find<BaseController>().model1.service_id != 1 && Get.find<BaseController>().model1.service_id != 3){
                                  if(index==0){
                                    controller.getDailog(0, context);
                                  }
                                  else if(index == 1){
                               ...
                               if(Get.find<BaseController>().model1.service_id != 1){
                                  if(index==4){
                                    controller.getDailog(4, context);
                                  }
                                  else if(index == 5){
                              ...
                              child: Padding(
                                  padding: const EdgeInsets.only(right: 5, left: 5, top: 5,bottom: 0),
                                  child: ListTile(
                                    ...
                                    leading: Container(
                                      decoration: BoxDecoration(
                                          ...
                                          boxShadow: [
                                            BoxShadow(
                                              color: ThemeConstants.bluecolor.withOpacity(0.5),
                                              spreadRadius: -3.9, // Negative value to contain the shadow within the border
                                              blurRadius: 9,
                                              offset: const Offset(0, 6),
                                            )
                                          ]
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.all(8.0),
                                        child: Image.asset(iconss[index],scale: 20,),
                                      ),),
                                    title: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: CustomAutoSizeTextMontserrat(
          ...
          bottomNavigationBar: CustomButtomNavbar(currentIndex: 1, context2: context,),
        ));
  }
}
