...
class _CourseSearchState extends State<CourseSearch> {
  ...
  callbackCountryLevel(data) {
    controller.setCountryDropdown(data);
    for (var i = 0; i < controller.country.countrylist!.length - 1; i++) {
      if (controller.country.countrylist![i] == data) {
        print(i);
      }
    }
  }

  callbackCourseLeve(data) {
    controller.setCourseDropdown(data);
  }
                                  ...
                                  SizedBox(
                                    ...
                                    child: Padding(
                                        ...
                                        child: CustomDropDown(
                                          hint: "Select Country *",
                                          model: controller.country.countrylist,
                                          callbackFunction:
                                              callbackCountryLevel,
                                        )),
                                  )
                                ],
                              ),
