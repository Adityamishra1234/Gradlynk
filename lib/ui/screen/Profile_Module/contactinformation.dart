        ...
        body: controller.obx((state) {
          try {
            if (controller.loadingStudentPanelData.value == 1) {
              for (var i = 0;
                  i < controller.model.addtionalDetails!.length;
                  i++) {
              ...
              mobileNumber.text =
                  getNUllChecker(controller.model.mobile) == false
              ...
              for (var i = 0; i < gender.length; i++) {
                if (gender[i].toString() ==
                    controller.model.gender.toString()) {
              ...
              if (controller.model.otherCountryOfInterest != null) {
                for (var i = 0;
                  ...
                  if (i == 0) {
                    temp = controller
                        .model.otherCountryOfInterest![i].countryName!;
                  } else {
                    temp =
                                      ...
                                      onPressed: () {
                                        try {
                                          if (getNUllChecker(firstName.text) ==
                                            ...
                                            getToast(SnackBarConstants
                                                .mobileNumberError!);
                                          } else if (getNUllChecker(alt_Number.text) ==
                                              true) {
                                            getToast(SnackBarConstants
                                            ...
                                            getToast(
                                                SnackBarConstants.stateError!);
                                          } else if (getNUllChecker(
                                              controller.citySelected)) {
                                            getToast(
                                                SnackBarConstants.cityError!);
