          ...
          SizedBox(
            ...
            child: CustomDropDownSingle(
              model: controller1.loadingAffiliation.value == true
                  ...
                  : ["No data"],
              initialSelectedValue: controller1.loadingAffiliation.value == true
                  ? controller1.affiliationNameSelected ??
                          ...
                          onPressed: () async {
                            controller1.modelList
                              ...
                              qualificationId: controller1
                                  ...
                                  .toString(),
                              streamId: controller1.streamSelectedID.toString(),
                              countryId:
                              ...
                              affiliationId: controller1.affiliationCodeSelected
                                  .toString(),
                              passingInstId:
                                  controller1.institutionSelectedID.toString(),
                              educationStatus:
                                  controller1.educationStatusSelected,
                              yearOfPassing: controller1.yearOfPassingSelected,
