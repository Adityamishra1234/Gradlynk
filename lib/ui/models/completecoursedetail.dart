class CompleteCourseDetail {
  ...
  CompleteCourseDetail.fromJson(Map<String, dynamic> json) {
    ...
    totalTutionFees = json['total_tution_fees'];
    totalTutionFeesInr = json['total_tution_fees_inr'];
    ...
    averageSalary = json['average_salary'];
    averageSalaryInr = json['average_salary_inr'];
    applicationTat = json['application_tat'];
    ...
    noOfBacklogs = json['no_of_backlogs'];
