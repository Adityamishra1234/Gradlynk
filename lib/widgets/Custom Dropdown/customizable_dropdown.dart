...
class CustomizableDropdown extends StatefulWidget {
  ...
  @override
  CustomizableDropdownState createState() => CustomizableDropdownState();
}

class CustomizableDropdownState extends State<CustomizableDropdown>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  final ScrollController scrollControler = ScrollController();
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  showModalBottomSheet(
                    ...
                    widget.itemList.length > 8 ? 0.55 : 0.05 + (0.060 * items.length),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: ThemeConstants.blackcolor.withOpacity(0.8), // Custom handle color
                                  borderRadius: BorderRadius.circular(10),
                                ),
                              ),
                              if (widget.itemList.length > 8)
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: SizedBox(
                                    height: 50,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          widget.icon != null
                            ...
                            width: 30,
                            child: RotationTransition(
                                turns: Tween(begin: 0.25, end: 0.25)
                                    .animate(_controller),
                                child: widget.icon),
                          )
                              : Container()
